...
pub struct OrderMetadata {
    ...
    /// sell amount (before fee) for sell order, buy amount for buy order
    ///
    /// This field can be U256 while in crate::order::OrderMetadata it is BigRational because the
    /// other amount could be larger than a U256.
